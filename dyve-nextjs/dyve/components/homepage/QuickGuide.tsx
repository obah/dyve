const QuickGuide = () => {
  return (
    <div className="mt-20 flex w-full items-center justify-center rounded-r1 p-8">
      <div className="w-full rounded-r1 bg-eclipse-bg bg-cover bg-center bg-no-repeat">
        <div className="flex h-[200px] flex-col items-center justify-center rounded-t-r1 bg-background-2 p-8 text-center">
              ...
              <div className="flex w-8/12 flex-row items-center justify-between">
                ...
                <div className="w-11/12 p-4 text-center">
                  ...
                  <p className="text-xl font-normal text-white-4">
                    ...
                    account. Fill in your personal information and choose a
                    secure password. Verify your email to complete the
